...
const main = async () => {
    let alabama = await State.find({name: 'Alabama'})
    let alaska = await State.find({name: 'Alaska'})
    let arizona = await State.find({name: 'Arizona'})
    let arkansas = await State.find({name: 'Arkansas'})
